...
userdetails = f"""select * from `userorder` where `finalstatus`='delivered' and `deliverypersonId`='{eid}'"""
cur.execute(userdetails)
user = cur.fetchall()


wholesalerdetails = f"""select * from `whorder` where `finalstatus`='delivered' and `deliverypersonId`='{eid}'"""
        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="./completedOrders.py?id={eid}">Completed orders</a>
                    </li>
                    <li class="nav-item">
