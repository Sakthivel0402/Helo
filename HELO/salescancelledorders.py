...
userdetails = f"""select * from `userorder` where `userstatus`='cancelled'"""
cur.execute(userdetails)
user = cur.fetchall()

wholesalerdetails = f"""select * from `whorder` where `wholesalerstatus`='cancelled' """
...
<body>
  <div class="d-flex justify-content-center mb-4"><h1>Cancelled orders</h1></div>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-3 col-lg-2 d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
                ...
                <li class="nav-item "> """)
print(f"""      <a class="nav-link " href="./salesDashboard.py?id={eid}" >
                        Dashboard
                    </a>
                </li>
                      <li class="nav-item">
...
if user:
    ...
    print("<h2>No cancelled orders found.</h2>")
