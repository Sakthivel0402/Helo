...
userdetails = f"""select * from `userorder` where `companystatus`='C TO A' and `salesstatus`='delivery'"""
cur.execute(userdetails)
user = cur.fetchall()

wholesalerdetails = f"""select * from `whorder` where `companystatus`='C TO W' and `salesstatus`='delivery'"""
...
<body>
  <div class="d-flex justify-content-center mb-4"><h1>Old orders(Sales)</h1></div>
        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
                 <ul class="nav nav-pills flex-column mb-auto">
                  ...
                  <li class="nav-item ">
                          <a class="nav-link " href="./saleEmployeeProfile.py?id={eid}" >
                              Profile
                          </a>
                      </li>
                      </ul>
...
if wholesaler:
    print("""     <h3 class="mt-5">Wholesaler orders:</h3>
                    <table class="table mt-3 table-bordered ">
                        <thead class="thead-dark">
                          <tr class="table-dark">
                            <th scope="col">Order ID</th>
