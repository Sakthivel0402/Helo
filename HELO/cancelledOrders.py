...
userdetails = f"""select * from `userorder` where `companystatus`='cancelled' or `userstatus`='cancelled' """
              ...
              <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item active " href="./cancelledOrders.py?id={id2}">Cancelled orders</a></li>
