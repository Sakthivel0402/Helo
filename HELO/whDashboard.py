...
whdetails=f"""select * from whoregistration where id={wid}"""
cur.execute(whdetails)
...
<body>
  <div class="d-flex justify-content-center mb-4"><h1>Wholesaler Dashboard</h1></div>
<a href="./whLogin.py" class="btn btn-danger h-25  me-5 float-end">Logout</a>   
        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
                <ul class="nav nav-pills flex-column mb-auto">
                   ...
                   <li class="nav-item ">
                  <a class="nav-link active " href="./whDashboard.py?id={wid}" >
                      Dashboard
                  </a>
              </li>
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="./whNeworders.py?id={wid}&oid={oid}">New orders</a></li>
