...
cur = con.cursor()
query2 = """ select * from whoregistration where status='accepted'"""
query3 = """ select * from whoregistration where status='declined'"""
cur.execute(query3)
...
"<body>
  <div class="d-flex justify-content-center mb-4"><h1>Old Wholesaler</h1></div>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 d-flex flex-column flex-grow-1 p-3">
              <h3>Accepted wholesaler details:</h3>
...
<div class="modal fade" id="exampleModal{i[0]}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div > <h5>id: <span>{i[0]}</span></h5> <h5>Company name: <span>{i[1]}</span></h5> <h5>Contact person name: <span>{i[2]}</span></h5> <h5>Contact person number: <span>{i[3]}</span></h5>  <h5>Company email: <span>{i[4]}</span></h5> <h5>Company phone: <span>{i[5]}</span></h5> <h5>Address line1: <span>{i[6]}</span></h5> <h5>Address line2: <span>{i[7]}</span></h5> <h5>city: <span>{i[8]}</span></h5> 
...
print("""
     ...
     <hr>
              <h3 class="mt-5">Declined wholesaler details:</h3>
                 <table class="table mt-3 table-bordered ">
                     <thead class="thead-dark">
                       <tr class="table-dark">
                         <th scope="col">ID</th>
...
for i in declineloop:
    print(
        f""" <form method="post"> <tr><td>{i[0]}<input type="hidden" name="rowid" value="{i[0]}"</td> 
        <td>{i[1]}</td> 
        <td>{i[4]}</td> 
        <td>{i[12]}</td>
        <td>{i[15]}</td>
        <td>{i[13]}</td> 
        <td><button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal{i[0]}">
  View more
</button>
</form>
</td>
