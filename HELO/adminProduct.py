...
"<body>
  <div class="d-flex justify-content-center mb-4"><h1> Company details</h1></div>
...
print(f"""      <h2 name="cname">Products from all companies! </h2>
...
for i in details:
    print(
        f""" <form method="post" enctype="multipart/form-data"> <tr><td>{i[1]} <td>{i[2]}</td> <td><a href="./productViewmore.py?cname={i[1]}" name="viewmore" class="btn btn-warning">view more</a>
</td> </tr> </form>""")
print("""
    </table>
    </div>
