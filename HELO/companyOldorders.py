...
products = f"""select * from userorder where `cname`='{cname}' and  `orderstatus`='processed' and `companystatus`='C TO A' """
...
<body>
  <div class="d-flex justify-content-center mb-4"><h1>Old orders</h1></div>
...
if product:
    ...
    print("<h2>No old orders found.</h2>")
