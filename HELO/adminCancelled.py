...
userdetails = """select * from `userorder` where  `userstatus`='cancelled' """
cur.execute(userdetails)
user = cur.fetchall()

wholesalerdetails = """select * from `whorder` where `wholesalerstatus`='cancelled'"""
            ...
            <div class="col-md-3 col-lg-2 d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item active" href="./adminCancelled.py">Cancelled orders</a></li>
