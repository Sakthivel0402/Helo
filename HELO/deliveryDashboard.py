...
query=f"""select * from empreg where id='{eid}' and designation='delivery'"""
cur.execute(query)
query2=cur.fetchall()
...
<body>
  <div class="d-flex justify-content-center mb-4"><h1>Delivery Dashboard</h1></div>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            <div class="col-md-3 col-lg-2 d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
                ...
                <li class="nav-item ">
                  <a class="nav-link active" href="./deliveryDashboard.py?id={eid}" >
                      Dashboard
                  </a>
              </li>
                    <li class="nav-item">
                   ...
                   <li class="nav-item ">
                        <a class="nav-link" href="./deliveryEmployeeProfile.py?id={eid}" >
                            Profile
                        </a>
                    </li>
                    </ul>
