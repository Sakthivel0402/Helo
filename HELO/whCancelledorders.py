...
userdetails = f"""select * from `whorder` where `finalstatus`='cancelled' or `wholesalerstatus`='cancelled' """
...
<head>
    ...
    <title>wholesaler order status </title>
            ...
            <div class="col-md-3 col-lg-2 d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item active" href="./whCancelledorders.py?id={wid}">Cancelled orders</a></li>
...
if user:
    ...
    print("""<h2 class="text-center text-warning mt-5"> No orders found.""")
