...
userdetails=f"""select * from `userorder` where `companystatus`='C TO A'"""
cur.execute(userdetails)
user=cur.fetchall()

wholesalerdetails=f"""select * from `whorder` where `companystatus`='C TO W'"""
...
<body>
  <div class="d-flex justify-content-center mb-4"><h1>Orders</h1></div>
            ...
            <div class="col-md-3 col-lg-2 d-flex flex-column flex-shrink-0 p-3 bg-light" id="sidebar">
                ...
                <li class="nav-item ">
                 ...
                 <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                      <li><a class="dropdown-item active" href="./adminNeworders.py">Ongoing orders</a></li>
...
if wholesaler:
    ...
    print("""
     ...
     print("<h2 class='mb-5'>Wholesalers: No new orders found.</h2>")
